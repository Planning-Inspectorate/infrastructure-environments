locals {
  ...
  master_geojson_url                           = "https://back-office-applications-docs-train.planninginspectorate.gov.uk/published-documents/gis-boundaries/all-project-boundaries.geojson"
