...
| <a name="input_service_bus_appeals_bo_document_copy_topic_id"></a> [service\_bus\_appeals\_bo\_document\_copy\_topic\_id](#input\_service\_bus\_appeals\_bo\_document\_copy\_topic\_id) | Back Office Storage Container name for documents | `string` | n/a | yes |
