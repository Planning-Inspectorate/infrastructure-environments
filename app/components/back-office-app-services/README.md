...
| <a name="input_servicebus_topic_nsip_project_id"></a> [servicebus\_topic\_nsip\_project\_id](#input\_servicebus\_topic\_nsip\_project\_id) | Service BUs Topic nsip-project id | `string` | n/a | yes |
