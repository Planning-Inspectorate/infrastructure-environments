...
| <a name="input_document_storage_domain"></a> [document\_storage\_domain](#input\_document\_storage\_domain) | The custom domain for the storage account used for back office documents | `string` | n/a | yes |
