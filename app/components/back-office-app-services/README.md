...
| <a name="input_front_office_storage_account_id"></a> [front\_office\_storage\_account\_id](#input\_front\_office\_storage\_account\_id) | Front Office storage account id | `string` | n/a | yes |
