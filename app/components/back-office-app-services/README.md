...
| <a name="input_malware_scanning_topic_name"></a> [malware\_scanning\_topic\_name](#input\_malware\_scanning\_topic\_name) | Event grid topic name for publishing malware scan results | `string` | n/a | yes |
