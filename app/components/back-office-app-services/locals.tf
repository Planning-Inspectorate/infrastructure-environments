  ...
  app_services = {
    back_office_frontend = {
      ...
      app_settings = {
        ...
        AZURE_AI_DOC_REDACTION_STORAGE_NAME        = var.azure_ai_doc_redaction_storage_name
        AZURE_AI_DOC_REDACTION_REDACT_KEY          = local.secret_refs["azure-ai-doc-redaction-redact-key"]
        AZURE_AI_DOC_REDACTION_APPLY_KEY           = local.secret_refs["azure-ai-doc-redaction-apply-key"]
