...
| <a name="output_appeal_documents_storage_container_id"></a> [appeal\_documents\_storage\_container\_id](#output\_appeal\_documents\_storage\_container\_id) | The Appeal Documents Storage Account container ID |
