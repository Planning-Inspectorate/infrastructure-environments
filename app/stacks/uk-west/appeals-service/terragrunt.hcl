...
inputs = {
  ...
  cosmosdb_connection_string                       = dependency.appeals_service_uks.cosmosdb_connection_string
  function_apps_storage_account                    = dependency.appeals_service_uks.function_apps_storage_account
  function_apps_storage_account_primary_access_key = dependency.appeals_service_uks.function_apps_storage_account_primary_access_key
