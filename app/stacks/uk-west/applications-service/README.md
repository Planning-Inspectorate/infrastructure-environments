...
| <a name="input_planned_outage_resume_text"></a> [planned\_outage\_resume_text](#input\_planned\_outage\_resume_text) | Optional text to be displayed when planned outage page is active | `string` | n/a | no |
