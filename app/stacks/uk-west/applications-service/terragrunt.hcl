...
dependency "back_office_ukw" {
  ...
  mock_outputs = {
    ...
    service_bus_service_user_topic_id              = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/mock_resource_group/providers/Microsoft.ServiceBus/namespaces/mock-namespace/topics/mock-topic"
...
inputs = {
  ...
  back_office_service_bus_service_user_topic_id               = dependency.back_office_ukw.outputs.servicebus_topic_service_user_id
