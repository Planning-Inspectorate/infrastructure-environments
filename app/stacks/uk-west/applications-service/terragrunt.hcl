...
inputs = {
  ...
  back_office_service_bus_nsip_advice_topic_id                  = dependency.back_office_ukw.outputs.service_bus_nsip_advice_id
  back_office_service_bus_nsip_advice_id                        = dependency.back_office_ukw.outputs.service_bus_nsip_advice_id
