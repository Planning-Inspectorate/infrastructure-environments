module "app_services" {
  ...
  document_storage_back_office_document_service_uploads_container_resource_manager_id = azurerm_storage_container.back_office_document_service_uploads_container.id
  document_storage_back_office_published_documents_container_resource_manager_id      = azurerm_storage_container.back_office_published_documents_container.id
  document_storage_submissions_container_resource_manager_id                          = azurerm_storage_container.back_office_submissions_container.id
