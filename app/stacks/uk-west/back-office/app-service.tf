module "app_services" {
  ...
  front_office_storage_account_host                                                   = azurerm_storage_account.back_office_documents.primary_blob_endpoint
  back_office_storage_account_host                                                    = azurerm_storage_account.back_office_documents.primary_blob_endpoint
  front_office_storage_container                                                      = azurerm_storage_container.back_office_appeals_document_container.name
