...
| <a name="input_back_office_document_storage_domain"></a> [back\_office\_document\_storage\_domain](#input\_back\_office\_document\_storage\_domain) | Custom domain for document storage | `string` | n/a | yes |
