...
| <a name="input_back_office_appellant_submission_topic"></a> [back\_office\_appellant\_submission\_topic](#input\_back\_office\_appellant\_submission\_topic) | Event bus topic name to send appellant submissions to | `string` | n/a | yes |
...
| <a name="input_back_office_lpa_response_submission_topic"></a> [back\_office\_lpa\_response\_submission\_topic](#input\_back\_office\_lpa\_response\_submission\_topic) | Event bus topic name to send lpa submissions to | `string` | n/a | yes |
