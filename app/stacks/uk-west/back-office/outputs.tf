...
output "service_bus_dco_portal_data_submissions_topic_id" {
  description = "ID of the dco_portal_data_submissions Service Bus Topic"
  value       = azurerm_servicebus_topic.dco_portal_data_submissions.id
}
