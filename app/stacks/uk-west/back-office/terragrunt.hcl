...
dependency "common" {
  ...
  mock_outputs = {
    ...
    back_office_integration_subnet_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/mock_resource_group/mock/mock_id/back_office_integration_subnet_id"
