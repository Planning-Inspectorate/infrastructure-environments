...
| <a name="input_feature_general_s51_bo"></a> [feature\_general\_s51\_bo](#input\_feature\_general\_s51\_bo) | Feature toggle to enable the general s51 register of advice from back office | `string` | n/a | yes |
