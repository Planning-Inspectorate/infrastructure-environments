...
| <a name="input_back_office_integration_get_s51_case_references"></a> [back\_office\_integration\_get\_s51\_case\_references](#input\_back\_office\_integration\_get\_s51\_case\_references) | list of case references (comma separated) that section 51 data is retrieved from back office | `string` | n/a | yes |
