...
dependency "back_office_ukw" {
  ...
  mock_outputs = {
    ...
    back_office_document_storage_connection_string     = "mockconnectionstring"
    ...
    document_check_function_storage_name               = "function_storage_name"
    document_check_function_storage_primary_access_key = "function_storage_primary_access_key"
...
inputs = {
  ...
  back_office_document_storage_connection_string     = dependency.back_office_ukw.outputs.back_office_document_storage_connection_string
  ...
  document_check_function_storage_primary_access_key = dependency.back_office_ukw.document_check_function_storage_primary_access_key
