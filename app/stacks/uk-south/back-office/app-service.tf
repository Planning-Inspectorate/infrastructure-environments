module "app_services" {
  ...
  document_storage_back_office_document_service_uploads_container_id   = var.document_storage_back_office_document_service_uploads_container_id
  ...
  document_storage_back_office_published_documents_container_id        = var.document_storage_back_office_published_documents_container_id
