...
inputs = {
  ...
  common_integration_functions_subnet_id          = try(dependency.common_uks.outputs.common_integration_functions_subnet_id, null)
  ...
  integration_functions_app_service_plan_id       = try(dependency.common_uks.outputs.app_service_plan_id, null)
