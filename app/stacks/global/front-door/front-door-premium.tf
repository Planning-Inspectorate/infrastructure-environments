...
resource "azurerm_cdn_frontdoor_custom_domain_association" "common" {
  ...
  cdn_frontdoor_route_ids        = [azurerm_cdn_frontdoor_route.common.id, azurerm_cdn_frontdoor_route.back_office_applications_service.id, azurerm_cdn_frontdoor_route.bback_office_appeals_service.id]
}
