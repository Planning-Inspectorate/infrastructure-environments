...
inputs = {
  ...
  back_office_storage_account_id                    = dependency.back_office_ukw.outputs.bo_storage_account_id
  back_office_storage_account_location              = dependency.back_office_ukw.outputs.bo_storage_account_location
  back_office_storage_account_blob_host             = dependency.back_office_ukw.outputs.bo_storage_account_blob_host
