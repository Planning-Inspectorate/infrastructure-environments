...
| [azurerm_frontdoor_firewall_policy.applications_frontend](https://registry.terraform.io/providers/hashicorp/azurerm/3.74.0/docs/resources/frontdoor_firewall_policy) | resource |
...
| <a name="input_applications_service_ssl_certificate_name"></a> [applications\_service\_ssl\_certificate\_name](#input\_applications\_service\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the applications service | `string` | `"pins-wildcard-cert-2025-01-02"` | no |
...
| <a name="input_back_office_appeals_ssl_certificate_name"></a> [back\_office\_appeals\_ssl\_certificate\_name](#input\_back\_office\_appeals\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the back office appeals service | `string` | `"pins-wildcard-cert-2025-01-02"` | no |
...
| <a name="input_back_office_ssl_certificate_name"></a> [back\_office\_ssl\_certificate\_name](#input\_back\_office\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the back office service | `string` | `"pins-wildcard-cert-2025-01-02"` | no |
...
| <a name="input_comment_planning_appeal_ssl_certificate_name"></a> [comment\_planning\_appeal\_ssl\_certificate\_name](#input\_comment\_planning\_appeal\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the Comment Planning Appeal | `string` | `"pins-wildcard-cert-2025-01-02"` | no |
...
| <a name="input_front_door_waf_appeals_redirect_url"></a> [front\_door\_waf\_appeals\_redirect\_url](#input\_front\_door\_waf\_appeals\_redirect\_url) | The URL to redirect a user to if a rule's action is Redirect | `string` | n/a | yes |
