...
| <a name="input_comment_planning_appeals_service_primary_app_service_url"></a> [comment\_planning\_appeals\_service\_primary\_app\_service\_url](#input\_comment\_planning\_appeals\_service\_primary\_app\_service\_url) | The primary App Service URL for the Appeals Service | `string` | n/a | yes |
| <a name="input_comment_planning_appeals_service_public_url"></a> [comment\_planning\_appeals\_service\_public\_url](#input\_comment\_planning\_appeals\_service\_public\_url) | The public URL for the Appeals Service frontend web app | `string` | n/a | yes |
| <a name="input_comment_planning_appeals_service_secondary_app_service_url"></a> [comment\_planning\_appeals\_service\_secondary\_app\_service\_url](#input\_comment\_planning\_appeals\_service\_secondary\_app\_service\_url) | The secondary App Service URL for the Appeals Service | `string` | `""` | no |
| <a name="input_comment_planning_appeals_service_ssl_certificate_name"></a> [comment\_planning\_appeals\_service\_ssl\_certificate\_name](#input\_comment\_planning\_appeals\_service\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the appeals service | `string` | `"pins-wildcard-digicert-221223"` | no |
