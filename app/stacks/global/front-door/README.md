...
| <a name="input_comment_planning_appeal_ssl_certificate_name"></a> [comment\_planning\_appeal\_ssl\_certificate\_name](#input\_comment\_planning\_appeal\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the Comment Planning Appeal Service | `string` | `"pins-wildcard-digicert-221223"` | no |
