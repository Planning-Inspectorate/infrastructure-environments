...
| <a name="input_appeals_service_ssl_certificate_name"></a> [appeals\_service\_ssl\_certificate\_name](#input\_appeals\_service\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the appeals service | `string` | `"pins-wildcard-digicert-221223"` | no |
...
| <a name="input_applications_service_ssl_certificate_name"></a> [applications\_service\_ssl\_certificate\_name](#input\_applications\_service\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the applications service | `string` | `"pins-wildcard-digicert-221223"` | no |
...
| <a name="input_back_office_appeals_ssl_certificate_name"></a> [back\_office\_appeals\_ssl\_certificate\_name](#input\_back\_office\_appeals\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the back office appeals service | `string` | `"pins-wildcard-digicert-221223"` | no |
...
| <a name="input_back_office_ssl_certificate_name"></a> [back\_office\_ssl\_certificate\_name](#input\_back\_office\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the back office service | `string` | `"pins-wildcard-digicert-221223"` | no |
| <a name="input_comment_planning_appeals_service_primary_app_service_url"></a> [comment\_planning\_appeals\_service\_primary\_app\_service\_url](#input\_comment\_planning\_appeals\_service\_primary\_app\_service\_url) | The primary App Service URL for the Comment Planning Appeals Service | `string` | n/a | yes |
| <a name="input_comment_planning_appeals_service_public_url"></a> [comment\_planning\_appeals\_service\_public\_url](#input\_comment\_planning\_appeals\_service\_public\_url) | The public URL for the Comment Planning Appeals Service frontend web app | `string` | n/a | yes |
| <a name="input_comment_planning_appeals_service_secondary_app_service_url"></a> [comment\_planning\_appeals\_service\_secondary\_app\_service\_url](#input\_comment\_planning\_appeals\_service\_secondary\_app\_service\_url) | The secondary App Service URL for the Comment Planning Appeals Service | `string` | `""` | no |
| <a name="input_comment_planning_appeals_service_ssl_certificate_name"></a> [comment\_planning\_appeals\_service\_ssl\_certificate\_name](#input\_comment\_planning\_appeals\_service\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the Comment Planning Appeals Service | `string` | `"pins-wildcard-digicert-221223"` | no |
