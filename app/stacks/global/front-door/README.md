...
| <a name="input_comment_planning_appeal_service_primary_app_service_url"></a> [comment\_planning\_appeal\_service\_primary\_app\_service\_url](#input\_comment\_planning\_appeal\_service\_primary\_app\_service\_url) | The primary App Service URL for the Comment Planning Appeal Service | `string` | n/a | yes |
| <a name="input_comment_planning_appeal_service_public_url"></a> [comment\_planning\_appeal\_service\_public\_url](#input\_comment\_planning\_appeal\_service\_public\_url) | The public URL for the Comment Planning Appeal Service frontend web app | `string` | n/a | yes |
| <a name="input_comment_planning_appeal_service_secondary_app_service_url"></a> [comment\_planning\_appeal\_service\_secondary\_app\_service\_url](#input\_comment\_planning\_appeal\_service\_secondary\_app\_service\_url) | The secondary App Service URL for the Comment Planning Appeal Service | `string` | `""` | no |
| <a name="input_comment_planning_appeal_service_ssl_certificate_name"></a> [comment\_planning\_appeal\_service\_ssl\_certificate\_name](#input\_comment\_planning\_appeal\_service\_ssl\_certificate\_name) | The SSL certificate name in the environment Key Vault for the Comment Planning Appeal Service | `string` | `"pins-wildcard-digicert-221223"` | no |
