...
| <a name="input_azuread_auth_application_id"></a> [azuread\_auth\_application\_id](#input\_azuread\_auth\_application\_id) | The Azure AD app registration ID representing the App Service for authentication | `string` | `null` | no |
| <a name="input_azuread_auth_enabled"></a> [azuread\_auth\_enabled](#input\_azuread\_auth\_enabled) | Flag to indicate if the App Service should use Azure AD for authentication | `bool` | `false` | no |
